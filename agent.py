...
from config import PLOT_HISTORY_GRAPH
...
class Agent():
    ...
    def get_preds(self, state):
        ...
        value_array = preds[0]  # value head
        logits_array = preds[1]  # policy head
        value = value_array[0]
    ...
    def getAV(self, tau):
        ...
        # referencias: AlphaGo Zero - Mastering the game of Go without human knowledge, page 26, Play
    ...
    def replay(self, ltmemory):
        ...
        if PLOT_HISTORY_GRAPH:
            # plt.show()
            time.sleep(1.0)
            plt.savefig(
                'run/history/{}_history.png'.format(str(int(time.time()))))
